...
app = Client("tiktokd'zab", bot_token=bot_token, api_id=api, api_hash=hash, workers=workers)



@app.on_message(filters.command('start'))
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/roobini-gamer/TikTokD-zab-Bot")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am **TikTok D'zab Downloader Bot**.\nI can download TikTok video without Watermark.\n\n"
                          "__**Developer :**__ __@P0P_B0B__\n"
